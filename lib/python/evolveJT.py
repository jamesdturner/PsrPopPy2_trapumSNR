...
def generate(ngen,
    ...
    for surv in surveys:
        surv.nbeaming = 0 # number beaming away
...
#                continue
            ...
            if surveyList is not None:
                ...
                for surv in surveys:
                    ...
                    if pulsar.beaming == False:
                        # pulsar is beaming away
                        surv.nbeaming +=1
                        continue
                        
                    elif SNR > surv.SNRlimit:
    ...
    if not nostdout:
        ...
        print "  Total beaming away {0}".format(surv.nbeaming)
        print "  Total detected = {0}".format(pop.ndet)

        for surv in surveys:
            print "\n  Results for survey '{0}'for pulsars beaming towards Earth:".format(surv.surveyName)
